...
import { UniswapPairV2ABI, UniswapPairV2Types } from '.'
...
export class PairContractFactory
  ...
  implements UniswapPairV2Types.Contract
{
  ...
  constructor(
    ...
    this._contractDetail = {
      ...contractDetail,
      abi: contractDetail.abi || UniswapPairV2ABI,
    }

    this._contract =
      this._multicallProvider.getContract<UniswapPairV2Types.ContractContext>(
        this._contractDetail,
      )
   ...
   * @returns The reserves of the pair.
   */
  public async getReserves(): Promise<UniswapPairV2Types.GetReserves> {
    return this.callContractMethod<UniswapPairV2Types.GetReserves>(
      'getReserves',
      [],
    )
  }
