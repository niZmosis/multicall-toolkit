...
import { Erc20ContractFactory } from '../../src/token/erc20-contract.factory'

describe('Erc20ContractFactory', () => {
  ...
  const contractFactory = new Erc20ContractFactory(mockMulticallProvider, {
