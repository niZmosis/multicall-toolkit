...
import { WrappedContractFactory } from '../../src/wrapped/wrapped-contract'

describe('WrappedContractFactory', () => {
  ...
  const contractFactory = new WrappedContractFactory(mockMulticallProvider, {
