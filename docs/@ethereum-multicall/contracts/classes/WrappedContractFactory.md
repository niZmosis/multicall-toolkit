...
[Documentation v3.0.0](../../../packages.md) / [@ethereum-multicall/contracts](../README.md) / WrappedContractFactory

# Class: WrappedContractFactory
...
### new WrappedContractFactory()

> **new WrappedContractFactory**(`multicallProviderContext`, `contractDetail`): [`WrappedContractFactory`](WrappedContractFactory.md)
...
[`WrappedContractFactory`](WrappedContractFactory.md)
...
`WrappedContract.Contract.allowance`

#### Defined in

contracts/src/wrapped/wrapped-contract.ts:419
...
contracts/src/wrapped/wrapped-contract.ts:435
...
`WrappedContract.Contract.approve`
...
`WrappedContract.Contract.balanceOf`

#### Defined in

contracts/src/wrapped/wrapped-contract.ts:334
...
contracts/src/wrapped/wrapped-contract.ts:343
...
`WrappedContract.Contract.decimals`
...
`WrappedContract.Contract.deposit`

#### Defined in

contracts/src/wrapped/wrapped-contract.ts:399
...
contracts/src/wrapped/wrapped-contract.ts:409
...
contracts/src/wrapped/wrapped-contract.ts:390
...
`WrappedContract.Contract.symbol`

#### Defined in

contracts/src/wrapped/wrapped-contract.ts:353
...
contracts/src/wrapped/wrapped-contract.ts:361
...
`WrappedContract.Contract.totalSupply`
...
`WrappedContract.Contract.transfer`

#### Defined in

contracts/src/wrapped/wrapped-contract.ts:372
...
`WrappedContract.Contract.transferFrom`
...
`WrappedContract.Contract.withdraw`
